...
insert into person(idperson, name, vorname, strasse, strassen_nr, wohnort, wohnort_plz, idfunktion, idabteilung) values (19,'Köhli', 'Mamma', 'Plauschweg', 69, 'Köhlhausen', 1313, 99, 25);
